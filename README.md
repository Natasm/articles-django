# Artius Django Tech Test Backend
...
## (Option 2) Running with a virtual environment
...
- (Bonus) Add unit tests for any code written to implement the tasks using a testing framework of your choice.
